// Catalogue produit simulant une source de données séparée
const products = [
  {
    id: 1,
    name: "Scrunchie doux",
  ...
  },
  {
    ...
    stock: 8,
    category: "scrunchies",
    image: "https://placehold.co/400x400/f9e6e0/black?text=Scrunchie+Soie",
    description: "100% soie naturelle",
    longDescription: "Confectionné en soie naturelle, ce scrunchie offre un toucher ultra délicat et limite les marques sur les cheveux. Il convient parfaitement aux cheveux fragiles, aux coiffures de nuit et aux looks élégants qui demandent une finition subtile."
  },
  {
    id: 5,
    name: "Barrette Papillon",
    price: 7,
    stock: 12,
    category: "barrettes",
    image: "papillon.JPG",
